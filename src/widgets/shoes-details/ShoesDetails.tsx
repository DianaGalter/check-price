import type { Shoes } from "../../entities/product/product";
import { getProductImage } from "../../shared/lib/getProductImage";
import styles from "./ShoesDetails.module.scss";

interface ShoesDetailsProps {
  product: Shoes;
  onClose: () => void;
}

export const ShoesDetails = ({ product, onClose }: ShoesDetailsProps) => {
